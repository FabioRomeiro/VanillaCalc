   ...
   importCalculations() {
      ...
      this._service.requestCalculations()
        .then(allCalculations => 
            allCalculations.filter(calculation => 
                !this._listCalculation.calculations.some(existentCalculation =>
                  calculation.isEquals(existentCalculation)))
        )
        .then(newCalculations => 
          newCalculations.forEach(newCalculation => this._listCalculation.add(newCalculation)));
   }
